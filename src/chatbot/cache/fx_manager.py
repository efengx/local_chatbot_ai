...
from src.chatbot.cache.fx_ssdata_manager import FxSSDataManager
...
def manager_factory(manager="map",
    ...
    return fx_get_data_manager(s, v, o, e)


def fx_get_data_manager(
    ...
    return FxSSDataManager(cache_base, vector_base, object_base, eviction_base, max_size, clean_size, eviction)
